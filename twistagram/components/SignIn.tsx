  ...
  return (
    <div className="bg-gray-800 h-screen w-screen  flex justify-center items-center ">
      <div className="flex items-center justify-center h-full w-full px-2">
        ...
        <form className="w-full md:w-1/3 lg:w-1/4 rounded-br-lg items-center justify-center px-4 lg:px-11 py-16  bg-white bg-opacity-10 rounded-2xl shadow-5xl relative z-2 border border-opacity-30 border-r-0 border-b-0 backdrop-filter backdrop-blur-sm mx-1.3">
          ...
          <div className="mb-6 mt-7">
            ...
            />
            <div className="flex justify-between mt-10 text-purple-400  mb-4 ">
              <button className="text-white bg-purple-500 hover:bg-gradient-to-l focus:ring-4 focus:ring-purple-200 dark:focus:ring-purple-800 rounded-lg text-sm px-6 py-2.5 text-center ">
                Sign In
              </button>
              <div className="mt-1">
